...
## The input datasets
 ...
 - _ZA7649_v2-1-0.sav_ - Eurobarometer 93.1 (2020) - DOI: [10.4232/1.14393](https://doi.org/10.4232/1.14393) - This dataset is *NOT* included in the repository. It has been provided by [GESIS](https://www.gesis.org/). It is licenced under the terms at this page[https://www.gesis.org/en/institute/data-usage-terms].
 The dataset can be downloaded at the followin URL: https://search.gesis.org/research_data/ZA7649

  - _EES9.sav_ - ESS9 - integrated file, edition 3.2 - DOI: [10.21338/ess9e03_2](https://doi.org/10.21338/ess9e03_2) - This dataset is included in the [repository](./datasets/ESS9.sav). It has been provided by [European Social Survey](https://europeansocialsurvey.org/). It is licenced under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). The dataset can be downloaded at the following URL: https://ess.sikt.no/en/datafile/b2b0bf39-176b-4eca-8d26-3c05ea83d2cb

  - _EES10.sav_ - ESS10 - integrated file, edition 3.2 - DOI: [10.21338/ess10e03_2](https://doi.org/10.21338/ess10e03_2) - This dataset is included in the [repository](./datasets/ESS10.sav). It has been provided by [European Social Survey](https://europeansocialsurvey.org/). It is licenced under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). The dataset can be downloaded at the following URL: https://ess.sikt.no/en/datafile/f37d014a-6958-42d4-b03b-17c29e481d3d


  - _EES11.sav_ - ESS11 - integrated file, edition 3.0  - DOI: [10.21338/ess11e03_0](https://doi.org/10.21338/ess11e03_0) - This dataset is included in the [repository](./datasets/ESS11.sav). It has been provided by [European Social Survey](https://europeansocialsurvey.org/). It is licenced under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). The dataset can be downloaded at the following URL: https://ess.sikt.no/en/datafile/242aaa39-3bbb-40f5-98bf-bfb1ce53d8ef

## Deliverable 1.1

The deliverable offers a detailed overview of major European social surveys, highlighting their complementarities and areas of overlap. Furthermore, it presents two case studies that will be developed in subsequent deliverables: the first explores attitudes towards immigration, combining data from the European Social Survey (ESS) Round 10 (2020) and Eurobarometer 93.1 (2020); the second investigates the impact of COVID-19 on institutional trust, using a pseudo-panel constructed from two ESS waves.

For more details read the [Full Report](./reports/deliverable_1_1_v2_1.pdf).
